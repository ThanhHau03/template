    ...
    <div class="offcanvas-body p-0">
        <div data-simplebar class="h-100">
            <div class="card mb-0 p-3">
                        ...
                        <div class="col-4">
                            <div class="form-check card-radio">
                                ...
                                <label class="form-check-label p-0 avatar-md w-100" for="layout-color-light">
                                    <i class="uil-comment-verify position-absolute bottom-0 end-0 text-primary"
                                    id="icon"></i>
                                    <div id="sidebar-size">
                ...
                <div class="col-4">
                    <div class="color-scheme form-check card-radio">
                        <input class="form-check-input" type="radio" name="data-bs-theme" id="layout-color-dark"
                        value="dark">
                        <label class="form-check-label p-0 avatar-md w-100 bg-black" for="layout-color-dark">
                            <i class="uil-comment-verify position-absolute bottom-0 end-0 text-success"
                               id="icon"></i>
                            <div id="sidebar-size">
                                <span class="d-flex h-100">
                                    <span class="flex-shrink-0">
...
<div class="col-4" id="layout-detached">
    <div class="form-check sidebar-setting card-radio">
        ...
        <label class="form-check-label p-0 avatar-md w-100" for="data-layout-detached">
            <i class="uil-comment-verify position-absolute bottom-0 end-0 text-danger"
               id="icon"></i>
            <span class="d-flex h-100 flex-column">
